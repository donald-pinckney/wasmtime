(module
  ...
  (func $__original_main (type 8) (result i32)
    (local i32 i32 i32 f64 i32 f64 i32 i32 i32 i32)
    global.get 0
    local.set 0
    i32.const 32
    local.set 1
    ...
    local.get 2
    global.set 0
    f64.const 0x1.6b19a415f45e1p+2 (;=5.67344;)
    local.set 3
    i32.const 0
    local.set 4
    local.get 2
